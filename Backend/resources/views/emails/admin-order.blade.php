    ...
    <tbody>
        <tr>
            <td>
                ...
                <table border="0" bgcolor="#121212" cellpadding="0" cellspacing="0" width="640" role="presentation"
                        ...
                        <tr width="640" style="width: 640px; min-width: 640px; " align="center">
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                    style="width: 640px; min-width: 640px;" role="presentation" bgcolor="#7b0323">
                                    <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table cellpadding="0" cellspacing="0" border="0" align="center"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <img src="assets/logo-light-01.png" alt="Logo"
                                                                        width="220" height="35" class="logo">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table cellpadding="0" cellspacing="0" border="0" align="center"
                                                            width="640" style="width: 640px; min-width: 640px;"
                                                            role="presentation" bgcolor="#7b0323">
                                                            <tr>
                                                                <td height="35"
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="#FFF" width="40" align="left"
                                            style=" border-top:2px solid #CCCCCC;border-bottom:2px solid #CCCCCC;color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                        </td>
                                        <td bgcolor="#FFF" width="40" align="left"
                                            style=" border-top:2px solid #CCCCCC;border-bottom:2px solid #CCCCCC;color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                        </td>
